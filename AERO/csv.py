from csv_configs import visium_fuel_timeseries
#from csv_configs import flight_tape
from EDGEAERO import edgeaero

# CSV export configs stored here as accessable by both website and workers.
# Likely temporary location until they are stored in the database

CSV_EXPORT_CONFIGS = {
    'Visium Fuel Timeseries': visium_fuel_timeseries.CONFIGURATION,
    'Flight Tape': edgeaero.CONFIGURATION,
    'Edge Aerodynamics': {
